...
baseDirectory="/home/kaouther/Documents/GitHub/mira_final_project/ants"
dataDirectory="/home/kaouther/Documents/GitHub/mira_final_project/data"
outputDirectory="${baseDirectory}/Output/"
outputPrefix="${outputDirectory}/COPD1"

mkdir -p $outputDirectory

inspiration="${dataDirectory}/dir_lab_copd/copd1/copd1_iBHCT.nii.gz"
expiration="${dataDirectory}/dir_lab_copd/copd1/copd1_eBHCT.nii.gz"

inspirationMask="${dataDirectory}/dir_lab_copd/copd1/copd1_iBHCT_lungs.nii.gz" 
expirationMask="${dataDirectory}/dir_lab_copd/copd1/copd1_eBHCT_lungs.nii.gz"

inspirationPreprocessed="${outputDirectory}/COPD1I_preprocessed.nii.gz"
expirationPreprocessed="${outputDirectory}/COPD2E_preprocessed.nii.gz"
...
## Combine the two warp fields#!/bin/sh
export ITK_GLOBAL_DEFAULT_NUMBER_OF_THREADS=4
...
for i in 1 2;
  do
    ...
    rm -f $tmpInspirationLuitksnapng
    rm -f $tmpExpirationLung
    rm -f $tmpInspirationLungMask
    rm -f $tmpExpirationLungMask
